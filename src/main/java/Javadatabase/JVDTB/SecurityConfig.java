 ...
 * @author Admin
 */
import Javadatabase.JVDTB.services.UserService;
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception { 
        return http 
                .authorizeHttpRequests(auth -> auth 
                        .requestMatchers("/css/**", "/js/**", "/", "/oauth/**", "/register", "/error", "/bachthiennhan", "/cart", "/cart/**") 
                        .permitAll() // Cho phép truy cập không cần xác thực. 
                        .requestMatchers("/books/edit/**", "/books/add", "/books/delete") 
                        .hasAnyAuthority("ADMIN") // Chỉ cho phép ADMIN truy cập. 
                        .requestMatchers("/books/add", "/books") 
                        .hasAnyAuthority("ADMIN", "USER") // Chỉ cho phép ADMIN, USER truy cập. 
                        .requestMatchers("/api/**")
